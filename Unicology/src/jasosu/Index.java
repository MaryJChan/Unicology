...
public class Index {
	...
	static String sub_url = "http://www.jobkorea.co.kr/starter/PassAssay?FavorCo_Stat=0&Pass_An_Stat=0&OrderBy=0&EduType=0&WorkType=0&isSaved=0&Page=";
	static int page = 1;
	static String url = sub_url + page;        
	...
	public static void main(String[] args) throws IOException{
		...
		while(page <= 237) {
				...
				for(Element element:contents_Tag) {					
					...
					// main_sub_url 변수값에 "/starter/PassAssay/View/"이 포함될경우 아래 조건문 이동
					if(main_sub_url.contains("/starter/PassAssay/View/")) {
						// "http://www.jobkorea.co.kr" + main_sub_url을 Jsoup라이브러리 Document타입 doc변수로 저장
						Document doc = Jsoup.connect("http://www.jobkorea.co.kr" + main_sub_url).get();
						System.out.println("현재 접속할 url주소 : " + "http://www.jobkorea.co.kr" + main_sub_url);
						...
						for(int i = 0; i < title_Tag.size(); i++) {
	                        ...
	                        JasosuDTO jDto = new JasosuDTO(field.get(fi), title, contents);
