...
public class PassJasoOptionAction implements Action{
	...
	public ActionForward excute(HttpServletRequest request, HttpServletResponse response)
		...
		String selectOption = request.getParameter("selectOption").replaceAll("\\p{Z}", "");
		...
		criDto.setSelectOption(selectOption);
		criDto.setSearchKeyword(searchKeyword);
		...
		List<PassJasoDTO>list = pDao.passJasoOptionList(criDto);
		...
		// 전체 개수를 구함
		int totalCount = pDao.OptionCount(criDto);
